...
// task 3 : Given a type LearnerStats = { quizzes: number; videos: number; assignments: number; }, 
// create a type StatsAsStrings that has the same keys, but all values are strings.
type LearnerStats={
    quizzes:number;
    videos:number;
    assignments:number;
