...
var score = 14; // variable score with num
if (true) {
    var score_1 = 20; //another score variable inside block with diff value
    console.log(score_1); //printing score value inside if block
}
var COUNTRY = "India"; //declared COUNTRY as constant with value
